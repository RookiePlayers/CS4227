...
public class GameSetting{
    ...
    public VBox settingsDialog(){
        ...
        player1.getChildren().addAll(MazeParts.CURRENTUSER!=null?new Label(MazeParts.CURRENTUSER.getUsername()):textField,lbl);
        ...
        save.setOnAction(e->{
            Player play1=new Player(MazeParts.CURRENTUSER!=null?MazeParts.CURRENTUSER.getUsername():!textField.getText().equals("") ?textField.getText():"Player 1",3,0,0,preference.getSizeFactor(),preference.getSizeFactor(),new Maze.Composite.Cell(0,0,preference.getSizeFactor(),preference.getSizeFactor()));
            play1.setColor(c1);
            Player play2=new Player(!textField2.getText().equals("") ?textField2.getText():"Player 2",3,0,0,preference.getSizeFactor(),preference.getSizeFactor(),new Cell(0,0,preference.getSizeFactor(),preference.getSizeFactor()));
            play2.setColor(c2);
            ...
            MazeGameSettings.GAMESTATE=GameState.PLAYING;
